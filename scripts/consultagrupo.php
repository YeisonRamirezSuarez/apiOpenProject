...
<body>
    ...
    <body>
        ...
        <form action="envio1.php" method="post">
            ...
            <button class="button button2" type="submit" formaction="actualizaciongrupodinamicopagina.php">Actualizacion grupo </button>
            <button class="button button2" type="submit" formaction="registrogrupomiembropagina.php">Crear grupo con miembro por id</button>
            <button class="button button2" type="submit" formaction="registrogruposmiembrodinamico.html">Crear grupo con miembros en el arbol</button>
            <!-- <button class="button button2" type="submit" formaction="consultagrupo.html">Consulta grupo</button> -->
        </form>
        <script>
            <?php
